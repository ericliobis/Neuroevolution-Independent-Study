...
from Agent_Object import ACHebbRecurrentAgent
from Agent_Object import ACHebbRecurrentAgent_working
...
def train(paramdict):
    ...
    BATCHSIZE = params['bs']
    agent2 = ACHebbRecurrentAgent( [params['lr'], params['lr']*10],TOTALNBINPUTS, [params['hs']],NBACTIONS, [1,0], params['gr'],
                                   0, 0,device,1e-4,0,params['blossv'],BATCHSIZE, "ACmodel_hebb")
