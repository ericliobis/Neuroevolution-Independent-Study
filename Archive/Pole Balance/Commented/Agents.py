...
class Regular_Agent(object):
    def __init__(self,lr,isize,hsizes, num_actions,act_functions, cuda, gamma = 0.99, eps = 1e-4, weight_decay = 0 , batch_size= 1, model_save_name = "FFmodel"  ):
    ...
    def save_model(self):
        torch.save(self.policy.state_dict(), "Regular_agent_" + self.model_save_name)
...
class ACAgent(object):
    ...
    def __init__(self,lr,isize,hsizes, num_actions,act_functions, cuda, gamma = 0.99, eps = 1e-4, weight_decay = 0 ,blossv = 0.1, batch_size= 1,  model_save_name = "ACmodel"  ):
...
class ACRecurrentAgent(object):
    def __init__(self, lr, isize, hsizes, num_actions,act_functions, rec_layer_out, rec_layer_in, cuda, gamma = 0.99,  eps = 1e-4, weight_decay = 0, blossv = 0.1, batch_size = 1, model_save_name = "ACmodel_rec"  ):
        # lr (float []) = learning rate [0]- policy, [1] - critic
        # isize (int) = input size
        # hsizes (int []) = sizes of the hidden layers
        # num_actions (int) = output size (number of actions)
...
class ACHebbRecurrentAgent(object):
    def __init__(self, lr, isize, hsizes, num_actions,act_functions, rec_layer_out, rec_layer_in, cuda, gamma = 0.99,  eps = 1e-4, weight_decay = 0, blossv = 0.1, batch_size = 1, model_save_name = "ACmodel_hebb"  ):
        # lr (float []) = learning rate [0]- policy, [1] - critic
        # isize (int) = input size
        # hsizes (int []) = sizes of the hidden layers
        # num_actions (int) = output size (number of actions)
