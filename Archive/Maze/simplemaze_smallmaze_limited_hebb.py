...
class Network(nn.Module):
    ...
    def __init__(self, isize, hsize): 
        ...
        self.perc_not_froze = 20 #1/perc_not_froze will be usable
        ...
        if (numiter+1) % params['save_every'] == 0:
            ...
            with open('loss_'+suffix+'.txt', 'w') as thefile:
                for item in all_total_rewards[::10]:
                        thefile.write("%s\n" % item)
            torch.save(net.state_dict(), 'limithebb_torchmodel_'+suffix+'.dat')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--eplen", type=int, help="length of episodes", default=20)
    ...
    parser.add_argument("--nbiter", type=int, help="number of learning cycles", default=2000)
    parser.add_argument("--save_every", type=int, help="number of cycles between successive save points", default=1000)
    parser.add_argument("--pe", type=int, help="number of cycles between successive printing of information", default=1000)
