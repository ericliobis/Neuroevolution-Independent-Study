...
def train(paramdict):
    ...
    net.load_state_dict(torch.load('200k_5by5_hidden10.dat'))
    ...
    lossbetweensaves = 0
    print("Rewards",sumreward)
    print("Reward Locs", [rposr, rposc])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hs", type=int, help="size of the recurrent (hidden) layer", default=10)
